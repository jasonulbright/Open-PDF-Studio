// Ported near-verbatim from PDFx src/renderer/src/ocr/ocr-client.ts (same
// owner): promise wrapper around the tesseract worker, plus the pdf.js
// page→ImageBitmap rasterizer (300 dpi, scale-capped).
